class RFormatInstruction extends Instruction {
    ...
    disassemble() {
        ...
        switch (mnemonic) {
            case 'LSL':
            case 'LSR':
                return `${mnemonic.padEnd(6)} X${this.rd}, X${this.rn}, #${this.shamt}`;
            case 'BR':
            ...
            case 'ORR':
            case 'EOR':
                return `${mnemonic.padEnd(6)} X${this.rd}, X${this.rn}, X${this.rm}`;
            default:
                return `${mnemonic.padEnd(6)} X${this.rd}, X${this.rn}, X${this.rm} ; (shamt=${this.shamt})`;
        }
    }
}
