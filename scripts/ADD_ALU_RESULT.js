...
ctx.lineTo(initialPosX + 100, initialPosY + 100);   // 60  110
ctx.lineTo(initialPosX + 100, initialPosY + 40);    // 60  50
...
ctx.fillText('ALU', initialPosX + 65, initialPosY + 74); 
ctx.fillText('result', initialPosX + 56, initialPosY + 90); 
