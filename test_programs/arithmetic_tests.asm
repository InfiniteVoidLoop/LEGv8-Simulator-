...
// Test 2: Phép trừ
addi x1, xzr, #100   // Khởi tạo lại x1
addi x2, xzr, #50    // Khởi tạo lại x2
...
addi x2, xzr, #50    // Khởi tạo lại x2
addi x3, xzr, #150   // Khởi tạo lại x3
...
// Test 6: Phép toán với register xzr (luôn = 0)
addi x1, xzr, #100   // Khởi tạo lại x1
addi x2, xzr, #50    // Khởi tạo lại x2
add x10, xzr, x1     // x10 = 0 + x1 = 100
add xzr, x1, x2      // xzr vẫn = 0 (không thể thay đổi)
...
addi x11, xzr, #10   // Khởi tạo lại x11
addi x12, xzr, #20   // Khởi tạo lại x12
subs x20, x11, x12   // x20 = 10 - 20 = -10, N=1, Z=0
subs x21, x12, x12   // x21 = 20 - 20 = 0, N=0, Z=1
addi x16, xzr, #1000 // Khởi tạo lại x16
addi x17, xzr, #2000 // Khởi tạo lại x17
